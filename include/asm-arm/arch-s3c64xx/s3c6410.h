...
#define S3C64XX_MEM_SYS_CFG_NAND	0x0008	//由0x0008改为0x0002又改为0x0008
...
#if defined(CONFIG_CLK_400_100_50)	//ARMCLK-HCLK-PCLK:400MHz-100MHz-50MHz
...
#endif
/**************************NAND FLASH #define*************************/
#define TACLS			0	/* TACLS 表示CLE/ALE与nWE之间的时间，要参考NAND手册中的时序图及说明确定 */
#define TWRPH0			1	// nWE Pulse Width
#define TWRPH1			0	//nWe rise edge to ALE/CLE falling edge.
#define NAND_DUR_VAL	((TACLS<<12) | (TWRPH0<<8) | (TWRPH1<<4))

/*-----------------------------------------------------------------------
 * Physical Memory Map
 */
#define DMC1_MEM_CFG	0x00010012	/* burst 4, 13-bit row, 10-bit col */
#define DMC1_MEM_CFG2	0xB45		//Read delay 1 cycle, Mobile DDR SDRAM, width 32-bit, some other configs.
//#define DMC1_CHIP0_CFG	0x150F8		/* 0x5000_0000~0x57ff_ffff (128 MiB) */
#define DMC1_CHIP0_CFG	0x1ff00		// 0x5000_0000~0x5fff_ffff (256MB), Bank-Row-Column organization. 
#define DMC_DDR_32_CFG	0x0 		/* 32bit, DDR */

/* Memory Parameters */
/* DDR Parameters */
#define DDR_tREFRESH		7800	/* us-->ns */
...
#define NS_TO_CLK(t)		((STARTUP_HCLK / 1000 * (t) - 1) / 1000000)//此处，同优先级的，从左向右的运算顺序，t由us转换为ns，所以"/1000".-1无大意义。
...
#define DMC_DDR_t_WTR		2	//内存规格书中无此项，未更改(以前用的是7)
/* 1tck + tIS(1.5ns) */
